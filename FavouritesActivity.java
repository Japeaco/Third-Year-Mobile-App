...
public class FavouritesActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapter = new FoodListAdapter(this, R.layout.food_items, favList);
        gridView.setAdapter(adapter);

        Cursor cursor = MainActivity.mydb.getData("SELECT * FROM RECIPES WHERE favourite = 'Yes'");
        favList.clear();
        ...
        gridView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            public void onItemClick(AdapterView<?> parent, View v, int position, long id) {
                String repName = favList.get(position).getName().toString().replaceAll("\\s+","");
                String recipeName = "com.example.admin.easyeats." + repName + "Activity";
                try {
                    Class<?> c = Class.forName(recipeName);
                    startActivity(new Intent(FavouritesActivity.this, c));
                } catch (ClassNotFoundException e) {
                    Toast.makeText(FavouritesActivity.this, e.toString(),
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_home) {
            ...
            Intent myIntent = new Intent(FavouritesActivity.this,
                    MainActivity.class);
