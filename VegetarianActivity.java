...
public class VegetarianActivity extends AppCompatActivity
        ...
        gridView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            public void onItemClick(AdapterView<?> parent, View v, int position, long id) {
                ...
                try {
                    ...
                    startActivity(new Intent(VegetarianActivity.this, c));
                } catch (ClassNotFoundException e) {
                    Toast.makeText(VegetarianActivity.this, e.toString(),
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.vegetarian, menu);
        return true;
    }
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_home) {
            ...
            Intent myIntent = new Intent(VegetarianActivity.this,
                    MainActivity.class);
